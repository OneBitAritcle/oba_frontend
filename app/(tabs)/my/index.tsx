...
export default function MyPage() {
  ...
  // ---------------------------------------------------------
  // 리스트 헤더 (ListHeaderComponent)
  // : 프로필 카드 + 타임라인 제목을 리스트의 '머리'로
  // ---------------------------------------------------------
  const renderHeader = () => {
    ...
    <View style={styles.container}>
      {isLoading ? (
        ...
        <FlatList
          ...
          keyExtractor={(item) => item.article_id} //string으로 변경해야하는지는 확인 필요
          
          // 프로필과 제목을 리스트의 머리로 넣음
